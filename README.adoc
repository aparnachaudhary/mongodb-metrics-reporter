...
image::https://travis-ci.org/aparnachaudhary/mongodb-metrics-reporter.png?branch=master["Build Status", link="https://travis-ci.org/aparnachaudhary/mongodb-metrics-reporter"] image::https://coveralls.io/repos/aparnachaudhary/mongodb-metrics-reporter/badge.png?branch=master&service=github["Build Status", link="https://coveralls.io/r/aparnachaudhary/mongodb-metrics-reporter?branch=master"]
